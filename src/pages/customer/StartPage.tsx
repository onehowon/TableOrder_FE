...
export default function StartPage() {
  ...
  return (
    <div className="relative w-full h-screen bg-white flex flex-col items-center justify-center px-4 font-woowahan">
      ...
      <div className="w-full max-w-md mx-auto mt-8 flex flex-col items-center relative font-woowahan">
      ...
      >
        ...
        {/* 회색 박스 */}
      <div className="bg-gray-100 rounded-2xl pt-10 pb-6 px-6 w-full font-woowahan">
      ...
      {/* 3) 버튼 그룹 */}
      <div className="w-full max-w-md mx-auto mt-8 space-y-4 font-woowahan">
        <button
          onClick={goOrder}
          className="w-full h-14 bg-green-600 text-white rounded-full text-lg font-semibold shadow-md hover:bg-green-700 transition-colors font-bold"
        >
          주문하기
        </button>
        <button
          onClick={callStaff}
          className="w-full h-14 bg-red-400 text-white rounded-full text-lg font-semibold shadow-md hover:bg-red-500 transition-colors font-bold"
        >
          직원호출
        </button>
      </div>
